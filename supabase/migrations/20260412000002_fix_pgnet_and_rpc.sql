-- Fix: remove unreliable pg_net / http extension calls from RPC.
-- Email notifications are now triggered by the frontend after the RPC
-- succeeds, so the database function only handles data creation.
...
-- =========================================================================
-- 2. Simplified RPC: create lead + quote + items (no email trigger)
-- =========================================================================
